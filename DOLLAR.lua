...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1989435972}
...
local UserName = (dp.username_ or "dollarTM")
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'dollarTM')..')'..' ❩\n⌁︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
...
if mrabs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'dollarTM')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
Dev_Abs(msg.sender_user_id_, msg.id_, 1, '⌁︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "dollarTM")..')', 1, 'md') 
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@dollarTM]'))
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@dollarTM]'))
Dev_Abs(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source DevProx     --
--        Contact         --
...
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙[Tws DevProx](https://t.me/FF4FFFE)
]]
...
{{text = '⌁ DevProx TeAM .',url="t.me/dollarTM"}},
}
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/dollarTM' end
...
ConstructorAbs = "["..Abs.first_name_.."](T.me/"..(Abs.username_ or "dollarTM")..")"
else 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/DevProxTEAM/DevDevProxFiles/main/getfile.json")
if res == 200 then
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙Channel ↬ [@dollarTM]', 1, 'md')    
end 
--     Source DevProx     --
